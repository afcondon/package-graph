...
(function($PS) {
  ...
  var Package = (function () {
      function Package(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      Package.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new Package(value0, value1, value2);
              };
          };
      };
      return Package;
  ...
  var Depend = (function () {
      function Depend(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      Depend.create = function (value0) {
          return function (value1) {
              return new Depend(value0, value1);
          };
      };
      return Depend;
  })();
  ...
  var n$prime = function (v) {
      return new Data_Tuple.Tuple(v.value0, new Data_Tuple.Tuple(v.value0, Data_Set.fromFoldable(Data_List_Types.foldableList)(Data_Ord.ordString)(v.value2)));
  };

  // | generic constructor for graph node
  var n = function (dictFoldable) {
      return function (dictOrd) {
          return function (dictOrd1) {
              return function (k) {
                  return function (v) {
                      return new Data_Tuple.Tuple(k, new Data_Tuple.Tuple(k, Data_Set.fromFoldable(dictFoldable)(dictOrd1)(v)));
                  };
              };
          };
      };
  ...
  var extractBody = function (v) {
      if (v instanceof Data_Either.Right) {
          return new Data_Either.Right(v.value0.body);
      };
      if (v instanceof Data_Either.Left) {
  ...
  var convert = function (packageMap) {
      var tuples = Data_Map_Internal.toUnfoldable(Data_List_Types.unfoldableList)(packageMap);
      var convert$prime = function (v) {
          return new Package(v.value0, v.value1.path, Data_List.fromFoldable(Data_Foldable.foldableArray)(v.value1.depends));
      };
